...
public class ForgotPass extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(255, 255, 255)), "Forgot Password", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 20), new java.awt.Color(255, 51, 0))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String b =empemail.getText();
        try{

            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/pm_log",Main.SqlLoginID,Main.SqlPassword);
            st=con.createStatement();
            String q="Select el.emp_pass from emp_details as ed,emp_login as el where ed.emp_id ='"+a+"' and ed.emp_email='"+b+"';";

            rs=st.executeQuery(q);
            if(rs.next()){
                 JOptionPane.showMessageDialog(null,"Password is : "+rs.getString("emp_pass"));
                 empid.setText("");
                 empemail.setText("");
                 this.dispose();
